    ...
    <div class="col s6 offset-s3">
        ...
        <div class="card hoverable">
            ...
            <div class="card-content">
                ...
                <div class="row">
                    <div class="col s12">
                        <span class="grey-text text-darken-4">Contenido de la publicacion.</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col s6">
        ...
        <div class="card hoverable">
            <div class="card-image waves-effect waves-block waves-light">
                <img class="" src="img/publicacion2.jpg">
            </div>
            <div class="card-content">
                <div class="row">  
                    <div class="col s3">
        ...
        <div class="card hoverable">
            <div class="card-image waves-effect waves-block waves-light">
                <img class="" src="img/publicacion4.jpg">
            </div>
            <div class="card-content">
                <div class="row">  
                    <div class="col s3">
        ...
        <div class="card hoverable">
            <div class="card-image waves-effect waves-block waves-light">
                <img class="" src="img/publicacion6.jpg">
            </div>
            <div class="card-content">
                <div class="row">  
                    <div class="col s3">
